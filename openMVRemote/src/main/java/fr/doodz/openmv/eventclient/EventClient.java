...
/*
    ...
    /**
     * Sends a ping to the OMV EventServer
     *
     * @throws IOException
     */
    ...
    /**
     * Tells OMV to do the action specified, based on the type it knows were it
     * needs to be sent.
     *
    ...
    /**
     * Implements a PingThread which tells OMV EventServer that the Client is
    ...
    private static class PingThread extends Thread {
        ...
        public PingThread(InetAddress hostAddress, int hostPort, int sleepTime) {
            super("OMV EventClient Ping-Thread");
            mHostAddress = hostAddress;
            mHostPort = hostPort;
